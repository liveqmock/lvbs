...
public class ZipUtil {
    ...
    public static void main(String[] args) {
       /* String str = "H4sIAAAAAAAAA8tIzcnJV1BLTEq2NTQyVijPL0pRBAEAI9XaURgAAAA=";
        System.out.println(gunzip(str));*/
    	byte[] bs = Base64.encodeBase64("userId=D31372C6117B30CE0320610EBF37212E&pageSize=20&type=2&pageIndex=1".getBytes());
