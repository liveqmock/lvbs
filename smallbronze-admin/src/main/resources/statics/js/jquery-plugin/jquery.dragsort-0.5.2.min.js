...
(function (e) {
    e.fn.dragsort = function (t) {
        ...
        this.each(function (t, o) {
            if (e(o).is("table") && e(o).children().length == 1 && e(o).children().is("tbody")) o = e(o).children().get(0);
            var u = {
                draggedItem: null,
                ...
                grabItem: function (t) {
                    ...
                    if (t.which != 1 || e(t.target).is(n.dragSelectorExclude) || e(t.target).closest(n.dragSelectorExclude).length > 0 || !o) return;
                    t.preventDefault();
                    var u = t.target;
                ...
                dragStart: function (t) {
                    ...
                    if (!n.dragBetween) {
                        var u = e(i.container).outerHeight() == 0 ? Math.max(1, Math.round(.5 + i.getItems().length * i.draggedItem.outerWidth() / e(i.container).outerWidth())) * i.draggedItem.outerHeight() : e(i.container).outerHeight();
                ...
                dropItem: function () {
                    ...
                    if (i.draggedItem.attr("data-origpos") != e(r).index(i) + "-" + e(i.container).children().index(i.draggedItem)) if (n.dragEnd.apply(i.draggedItem) == false) {
                        ...
                        if (o.length > 0) o.before(i.draggedItem); else if (s[1] == 0) e(r[s[0]].container).prepend(i.draggedItem); else e(r[s[0]].container).append(i.draggedItem)
                    }
                ...
                createDropTargets: function () {
                    ...
                    e(r).each(function () {
                        ...
                        if (t.length > 0 && r.length > 0) r.remove(); else if (t.length == 0 && r.length == 0) {
