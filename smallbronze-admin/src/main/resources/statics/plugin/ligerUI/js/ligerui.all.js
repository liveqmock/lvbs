...
(function ($) {
    ...
    $.ligerDialog.promptAudit = function (title, value, multi, callback) {
        var target = $('<input type="text" class="l-dialog-inputtext"/>');
        if (typeof (multi) == "function") {
            callback = multi;
        }
        ...
        p = {
            ...
            width: 320,
            buttons: [{
                text: $.ligerDefaults.DialogString.pass,
                onclick: btnclick,
                type: 'yes'
            }, {text: $.ligerDefaults.DialogString.noPass, onclick: btnclick, type: 'cancel'}]
        };
        return $.ligerDialog(p);
    };

     $.ligerDialog.promptAuditOk = function (title, value, multi, callback) {
        var target = $('<input type="text" class="l-dialog-inputtext"/>');
        if (typeof (multi) == "function") {
            callback = multi;
        }
        ...
        p = {
            ...
            target: target,
            width: 320,
            buttons: [{text: $.ligerDefaults.DialogString.ok, onclick: btnclick, type: 'cancel'}]
        };
        return $.ligerDialog(p);
    };
            ...
            g.tree.click(function (e) {
                ...
                //状态：没有张开
                    ...
                    if (p.slide) {
                        ...
                        $(this).parents('li').find('div.l-box').eq(0).click();
                    }
                    else {
