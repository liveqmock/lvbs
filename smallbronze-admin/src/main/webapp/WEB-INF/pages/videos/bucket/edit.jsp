...
<%@ include file="/WEB-INF/pages/common/page/loading.jsp"%>
    <div id="bucket_layout">
        ...
        <div position="right" title="已选择的视频">
            <input type="hidden" value="${bucket_id}" id="bucket_id">
            <input type="hidden" value="${bucket_id}" id="bucket_id_backup">
            <span>
                <button id="submit_bucket" class="operation_btn">提交</button>
            </span>
            <span>
                <textarea id="remarks" name="remarks" value="">${remarks}</textarea>
            </span>
            <div class="data_div">
